...
\section{Summary}
Using the VCD format and the GTKWave viewer logic simulation was performed quickly and verification of the ASL was greatly simplified.  Once verified an initial set of test vectors was created and fault simulations began.  The next chapter discusses the difficulties associated with performing fault simulation of the SSA BIST.  In addition certain methods are presented which greatly speed up the fault simulations and simplify the analysis of the results.  Finally the simulations performed and results are discussed.
