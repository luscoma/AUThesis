...
\bibitem{stroud-bridging-physical} C. Stroud, J.Emmert, J. Bailey, D. Nickolic and K Chhor, \textit{Bridging Fault Extraction from Physical Design Data for Manufacturing Test Development}, Proc. IEEE International Test Conference, 2000.

\bibitem{stroud-bridging} Emmert, J.M.; Stroud, C; Bailey, J.R;, ``A new bridging fault model for accurate fault behavior,'' \textit{AUTOTESTCON Proceedings, 2000 IEEE}, pp 481-485, 2000 doi: 10.1109/AUTEST.2000.885628 URL: \url{http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=885628&isnumber=19092}

\bibitem{parallelflts} Saab, D.G.; Hajj, I.N.; Rahmeh, J.T.; "Paralell-concurrent fault simulation," \textit{Computer Design: VLSI in Computers and Processors, 1989. ICCD '89, Proceedings., 1989 IEEE International Conference on}, pp.298-301,2-4 Oct 1989 doi: 10.1109/ICCD.1989.63376 URL: \url{http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=63376&isnumber=2316}

\bibitem{advancedverilog} Last, Ciletti, \textit{Advanced Digital Design The Verilog HDL}.  Prentice-Hall, 2004. Print.
