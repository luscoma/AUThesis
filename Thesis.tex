...
\begin{table}
  ...
  \begin{tabular}{p{2.5in}|p{3.5in}}
    ...
    \textbf{\$var} wire 1 ! A \textbf{\$end} & \multirow{4}{3.5in}{This section aliases each input with a single ASCII character. This shrinks long IO names condensing large simulation dumps greatly.} \\
