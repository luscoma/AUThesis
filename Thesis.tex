...
% Basic overview
Six measurements were developed using the previously discussed methods and used in fault simulations of the SSA BIST.  These six measurements were selected based on the underlying architecture of the BIST and an attempt was made to develop a set of measurements which would exercise as much of the BIST circuitry as possible.  As previously stated, no tool exists to develop these tests automatically so these measurements were developed iteratively with additional measurements added and existing measurements modified until a suitable fault coverage was obtained.
