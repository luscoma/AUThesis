...
\section{Summary}
Using both of these tools, makes logic simulation in AUSIM and test vector verification much simpler.  Once logic simulation has been performed and the output recorded for the fault-free representation of the circuit, fault simulations may begin.  The next chapter will discuss the difficulties associated with performing fault simulation of the SSA BIST.  In addition, methods used to greatly speed up the fault simulation and to simplify the analysis of the results will be discussed.
