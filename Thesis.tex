...
By analyzing the faults which were detected and undetected by the fault simulations performed in Chapter 4, a better understanding of the testability of the SSA BIST can be obtained.  Figure \ref{fig:blockdiagram} shows a block diagram of the basic architecture of the SSA BIST discussed in Chapter 2.  Each major sub-system of the SSA BIST is identified and the approximate fault coverage of the sub-system is given.  As shown in the figure, several areas of the BIST including the DDS, MACs, and reference CORDIC have greater than 95\% fault coverage.  
\begin{figure}
  \begin{center}
		\includegraphics[scale=1]{images/placeholder}
  \end{center}
  \label{fig:blockdiagram}
  \caption{Block Diagram and Fault Coverage of SSA BIST Sub-Systems}
\end{figure}
